    ...
    <nav class="nav" id="js-nav">
        <div class="nav-inner">
            ...
            <div class="nav-links">
                ...
                <a href="<?php echo e(route('tracking')); ?>">Lacak Order</a>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn-login">Buka Aplikasi</a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn-login">Login Staf</a>
    ...
    <section class="hero">
        ...
        <div class="hero-inner">
            <div class="hero-text">
                ...
                <div class="cta-group">
                    <a href="<?php echo e(route('tracking')); ?>" class="btn-main">Lacak Laundry Anda</a>
        ...
        <div class="container">
            <div class="about-grid">
                ...
                <div class="about-text reveal reveal-delay-1">
                    ...
                    <a href="<?php echo e(route('tracking')); ?>" class="btn-green">
        ...
        <div class="container">
            <div class="cta-banner reveal">
                ...
                <div class="cta-actions">
                    <a href="<?php echo e(route('tracking')); ?>" class="btn-main">🔍 Lacak Order</a>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('dashboard')); ?>" class="btn-outline">Buka Dashboard</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="btn-outline">Login Staf</a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <footer>
        <div class="footer-top">
            ...
            <div class="footer-col">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>">Login Staf</a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
...
<?php /**PATH C:\Users\User\Downloads\rinsa\resources\views/home.blade.php ENDPATH**/ ?>