...
<div class="login-card">
    ...
    <form method="POST" action="<?php echo e(route('login.post')); ?>">
        ...
        <div class="form-group">
            ...
            <input type="email" name="email" class="form-input"
                   value="<?php echo e(old('email')); ?>" placeholder="admin@rinsa.id" required autofocus />
        </div>
        <div class="form-group">
    ...
    <div class="login-track">
        Pelanggan? <a href="<?php echo e(route('tracking')); ?>">Lacak pesanan kamu</a>
    </div>
</div>

</body>
</html>
<?php /**PATH C:\Users\User\Downloads\rinsa\resources\views/auth/login.blade.php ENDPATH**/ ?>