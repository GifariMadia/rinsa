    ...
    <div class="form-card" style="margin-bottom:1rem">
        ...
        <div style="border-top:1px solid var(--rinsa-border);margin-top:1.25rem;padding-top:1.25rem">
            <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(120px,1fr));gap:1rem">
                ...
                <div>
                    <div style="font-size:.72rem;color:var(--rinsa-gray);text-transform:uppercase;letter-spacing:.5px;margin-bottom:4px">Opsi Kirim</div>
                    <div style="font-weight:600;font-size:.9rem">{{ $order->delivery_option === 'delivery' ? 'Kirim Kurir' : 'Ambil Sendiri' }}</div>
                </div>
                <div>
