            ...
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="avatar-upload-section">
                    <div class="avatar-preview-wrapper">
                        @php
                            $__rinsaEditAvatar = $user->avatar ?? null;
                            $__rinsaEditHasAvatar = $__rinsaEditAvatar && \Illuminate\Support\Facades\Storage::disk('public')->exists($__rinsaEditAvatar);
                        @endphp
                        @if($__rinsaEditHasAvatar)
                            <img src="{{ asset('storage/' . $__rinsaEditAvatar) }}" class="avatar-preview-img" id="previewImg">
                        @else
                ...
                <textarea name="bio" class="form-input" rows="4" placeholder="Tell us about your role...">{{ old('bio', $user->bio) }}</textarea>
