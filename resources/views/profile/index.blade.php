            ...
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="avatar-section">
                    <div class="avatar-wrapper">
                        @if(auth()->user()->avatar)
                            <img src="{{ asset('storage/' . auth()->user()->avatar) }}" alt="Avatar" class="avatar-img" id="avatarPreview">
                        @else
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $user->name) }}" required class="form-input" autocomplete="name">
                    </div>
                    ...
                    <div class="form-group form-group-full">
                        ...
                        <textarea name="bio" id="bio" rows="3" class="form-input" placeholder="Tulis sedikit tentang diri Anda..." style="resize: vertical;">{{ old('bio', $user->bio) }}</textarea>
                    </div>
                </div>
