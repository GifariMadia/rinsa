...
<body>
    ...
    <nav class="nav">
        ...
        <div class="nav-right">
            ...
            {{-- Avatar chip → Halaman Profil --}}
            @php
                $__rinsaUser = auth()->user();
                $__rinsaAvatar = $__rinsaUser->avatar ?? null;
                $__rinsaHasAvatar = $__rinsaAvatar && \Illuminate\Support\Facades\Storage::disk('public')->exists($__rinsaAvatar);
            @endphp
            <a href="{{ route('profile.index') }}" class="nav-user" aria-label="Lihat profil {{ $__rinsaUser->name }}">
                @if($__rinsaHasAvatar)
                    <img src="{{ asset('storage/' . $__rinsaAvatar) }}"
                         class="nav-user-avatar"
                         alt="Avatar {{ $__rinsaUser->name }}">
                @else
                    <span class="nav-user-initial" aria-hidden="true">
                        {{ substr($__rinsaUser->name, 0, 1) }}
                    </span>
                @endif
                {{ $__rinsaUser->name }}
            </a>
    ...
    <div class="layout">
        ...
        <aside class="sidebar" id="js-sidebar">
            ...
            {{-- Profile shortcut di bawah sidebar --}}
            <div class="sidebar-bottom">
                <a href="{{ route('profile.index') }}" class="sidebar-profile-chip">
                    @if($__rinsaHasAvatar)
                        <img src="{{ asset('storage/' . $__rinsaAvatar) }}"
                    ...
                    <div class="sidebar-profile-info">
                        <div class="sidebar-profile-name">{{ $__rinsaUser->name }}</div>
                        <div class="sidebar-profile-role">{{ ucfirst($__rinsaUser->role) }}</div>
                    </div>
                </a>
            </div>
        </aside>
    ...
    <div class="mobile-nav" aria-label="Navigasi mobile">
        <div class="mobile-nav-items">
            <a href="{{ route('dashboard') }}"
               class="mobile-nav-item {{ $current === 'dashboard' ? 'active' : '' }}">
                <span class="mobile-nav-icon">⊞</span><span>Dashboard</span>
            </a>
            <a href="{{ route('orders.index') }}"
               class="mobile-nav-item {{ $current === 'orders' ? 'active' : '' }}">
                <span class="mobile-nav-icon">◈</span><span>Order</span>
            </a>
            <a href="{{ route('customers.index') }}"
               class="mobile-nav-item {{ $current === 'customers' ? 'active' : '' }}">
                <span class="mobile-nav-icon">◉</span><span>Pelanggan</span>
            </a>
            <a href="{{ route('report') }}"
               class="mobile-nav-item {{ $current === 'report' ? 'active' : '' }}">
                <span class="mobile-nav-icon">◐</span><span>Laporan</span>
            </a>
            <a href="{{ route('profile.index') }}"
               class="mobile-nav-item {{ $current === 'profile' ? 'active' : '' }}">
                <span class="mobile-nav-icon">◎</span><span>Profil</span>
            </a>
        </div>
    </div>
